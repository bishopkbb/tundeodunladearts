        ...
        {selectedExhibition && (
          <>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[10000] flex items-center justify-center p-2 xs:p-4 bg-black/80 backdrop-blur-md overflow-y-auto touch-manipulation"
              onClick={() => setSelectedExhibition(null)}
            >
              <motion.div
                ...
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.9, y: 20 }}
                className="bg-white rounded-xl sm:rounded-2xl max-w-[90vw] md:max-w-3xl lg:max-w-4xl xl:max-w-5xl w-full max-h-[90vh] md:max-h-[85vh] overflow-y-auto shadow-2xl relative touch-manipulation my-auto"
              ...
              <div className="p-4 xs:p-6 sm:p-8 md:p-12">
                ...
                {selectedExhibition.subtitle && (
                  <p className="text-xl text-[#8B4513] italic mb-3">
                    {selectedExhibition.subtitle}
                  </p>
                )}
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8 p-6 bg-[#F5EFE7] rounded-xl">
                  <div>
                    <p className="text-sm text-[#8B4513] font-semibold mb-2">Event Dates</p>
                    ...
                    {selectedExhibition.openingTime && (
                      <p className="text-[#3D2817] mt-1">
                        Opening: {selectedExhibition.openingTime}
                      </p>
                    )}
                  </div>
                  <div>
                    <p className="text-sm text-[#8B4513] font-semibold mb-2">Venue</p>
                    <p className="text-[#3D2817]">{selectedExhibition.venue}</p>
                    {selectedExhibition.address && (
                      <p className="text-sm text-[#6B4423] mt-1">{selectedExhibition.address}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="prose max-w-none">
                  <h3 className="text-2xl font-bold text-[#3D2817] mb-4 font-serif">About This Event</h3>
